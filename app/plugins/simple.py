# -*- coding: utf-8 -*-
#!/usr/bin/python
""" Plugin module containing simple listeners/responders
"""
...
def hi_responder(message, groups):  # pylint: disable=unused-argument
    '''@mention with r'hi(|!)$'
Example: @bot hi!'''
    message.reply('Yo!')
